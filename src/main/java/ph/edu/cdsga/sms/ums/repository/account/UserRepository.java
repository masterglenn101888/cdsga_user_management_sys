...
//    SmsUser findByEmail(@Param("email") String email);
//
//    @Query(value = "SELECT u FROM SmsUser u WHERE u.email= :email")
...
//
//    @Query(value = "SELECT u FROM SmsUser u  WHERE u.studentIdNo = :userId")
//    SmsUser findByStudentId(@Param("userId") String userId);
//
